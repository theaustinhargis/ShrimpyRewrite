...
class Moderation(commands.Cog):
    ...
    @moderation.command(name="ban", description="Bans a specified user")
    ...
    @moderation.command(name="unban", description="Unbans a specified user")
    @commands.has_permissions(ban_members=True)
    ...
    @moderation.command(name="kick", description="Kicks a specified user")
    ...
    @moderation.command(name="timeout", description="Puts the specified user in timeout")
    ...
    @moderation.command(name="remove_timeout", description="Removes the specified user from timeout")
    @commands.has_permissions(moderate_members=True)
    ...
    @moderation.command(name="purge", description="Purges a specified amount of comments from the current channel")
