...
class Developer(commands.Cog):
    ...
    @commands.slash_command(name="reload_extension", description="Reloads specified extensions(s)")
    ...
    @commands.slash_command(name="load_ext", description="Loads specified extensions(s)")
    ...
    @commands.slash_command(name="unload_extension", description="Unloads specified extension(s)")
